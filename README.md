...
Small TypeScript CLI that **polls Kalshi markets** over REST and prints **YES/NO bid and ask** (and last trade) on each tick. Logging uses the **`ts-logger-pack` `Logger`** interface shape.
